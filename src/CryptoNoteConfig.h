...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1a9b5a;
...
const char     CRYPTONOTE_NAME[]                             = "danacoin;
...
const int      P2P_DEFAULT_PORT                              = 10230;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 10240;
