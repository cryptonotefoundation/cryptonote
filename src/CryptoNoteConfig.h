...
const size_t   BITCUTY_BLOCK_GRANTED_FULL_REWARD_ZONE        = 783333; // Magic-bit le bit MB, swap abracadabra octet par bit en devise, est la blockchain cryptonote Bitcuty !!!
...
const size_t   DIFFICULTY_CUT                                = 5759998;
