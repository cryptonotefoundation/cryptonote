...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(16417602225601500000) // 89% for generate
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(2029141848108040000) // 11% for the creator
