...
// Each BLOB is a link the chain the Block of the Bitcuty CryptoNote Blockchain !!! ¡¡¡
...
const uint64_t BITCUTY_MAX_BLOCK_NUMBER                      = 156250; // Maximum generation the blocks per blob !!! ¡¡¡
...
const size_t   BITCUTY_COINBASE_BLOB_RESERVED_SIZE           = 159688; // Equals nine percent of the block space ('data-in-binary')!!! ¡¡¡
