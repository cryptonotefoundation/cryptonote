...
**Drachmes: From Greek coinage** Drachma was the name given to the currency used by the Greeks. The name was used almost continuously from antiquity (Homer's time circa 800BC) to modern times (2001), when Greece succumbed along with other nations to the use of the multinational fiat pseudo-currency "Euro".
...
First node is at drachmes.net. We are currently in need of a second node in order to be able to launch. Tests have been made with temporary nodes.
